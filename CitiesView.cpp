...
void CCitiesView::OnInitialUpdate()
{
    ...
    m_oListCtrl.InsertColumn(CITY_COLUMN, _T("Ãðàä"), LVCFMT_LEFT, DEFAULT_COLUMN_WIDTH);
    m_oListCtrl.InsertColumn(RESIDENCE_COLUMN, _T("Îáëàñò"), LVCFMT_LEFT, DEFAULT_COLUMN_WIDTH);
